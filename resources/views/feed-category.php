		...
		<div class="container-box4-heading" >
            ...
            <div class="category">
                <div class="input-group mb-3">
                    <button class="shit btn btn-outline-secondary" type="button">All Categories</button>
                    <button class="shit btn btn-outline-secondary" type="button">Painting</button>
                    <button class="shit btn btn-outline-secondary" type="button">Plumbing</button>
                    <button class="shit btn btn-outline-secondary" type="button">Carpenting</button>
                    <button class="shit btn btn-outline-secondary" type="button">Electronics</button>
