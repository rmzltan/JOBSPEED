...
//display content of tblstudents
$displayContent="SELECT * from tblposting WHERE title like '%$searchContent%' || category like '%$searchContent%' || minSalary like '%$searchContent%'|| maxSalary like '%$searchContent%'|| location like '%$searchContent%'";
    ...
    <nav class="navbar navbar-expand-lg navbar-light p-md-1 sticky-top bgcolor">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="freelancer-add-info.html">Freelancer</a>
                </li>
                <li class="nav-item">
		...
		<div class="container-box4-heading" >
            ...
            <div class="category">
                <div class="input-group mb-3">
                        <button name="txtall" class="shit btn btn-outline-secondary" type="submit">All Categories</button>
                        <button name="txtpaint" class="shit btn btn-outline-secondary" type="submit">Painting</button>
                        <button name="txtplumb" class="shit btn btn-outline-secondary" type="submit">Plumbing</button>
                        <button name="txtcarp" class="shit btn btn-outline-secondary" type="submit">Carpenting</button>
                        <button name="txtelec" class="shit btn btn-outline-secondary" type="submit">Electronics</button>
            </form>
