...
<div class="container-box4">
	...
	<div class="index-grid-list">
        <div class="container-grid">
            @foreach ($serviceData->take(4) as $services )
            <div id="left" class="item">
                <a href="SignIn.blade.php" class="card">
                    <img src="{{ asset('Images/uploaded-services') . '/' . $services->service_image }}" alt="" class="thumb">
                    <article>
                        <h1>{{ $services->title }}</h1>
                        <div style="display:inline-block;margin-bottom:5px; margin-top:5px"><i class="fa-solid fa-location-dot"></i><span> {{$services->location}}</span></div>
                        <p>{{ $services->description }}</p>
                        <p>Starting at <span style="color:green;">&#8369; {{ $services->minPricing }}</span></p>
                        <div class="btngrp">
